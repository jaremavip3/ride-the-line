    ...
    <section className="px-6 py-16 lg:py-24 bg-black/90">
      <div className="max-w-3xl mx-auto">
        ...
        <div className="relative">
          {/* Title line */}
          <h3 className="text-xl lg:text-2xl text-white font-bold mb-6 text-center">
            Two cyclists, one goal - <span className="text-red-600">1500km</span> along the entire frontline in Ukraine
          </h3>

          {/* First paragraph */}
          <p className="text-pretty text-lg leading-relaxed tracking-wide text-gray-200 mb-4 font-medium">
            In the darkest times, while being in the worst shapes of their life, two desperate friends decided to cycle
            <span className="text-red-600 font-bold"> 1,500 km </span>
            along the entire front line in Ukraine, through liberated villages and towns, with a charitable purpose.
          </p>
          ...
          {/* Third paragraph */}
          <p className="text-pretty text-lg leading-relaxed tracking-wide text-gray-200 font-medium">
      ...
      {/* Decorative line */}
      <div className="h-0.5  w-11/12 bg-red-500/50 mx-auto mt-6 mb-10"></div>
      {/* Sponsors */}
      <div className="mt-8 ">
        ...
        <div className="flex flex-col gap-8 md:flex-row md:justify-center md:flex-wrap ">
          ...
          <div className="flex justify-center gap-8 h-22 md:h-14 md:gap-8">
            <div className="h-full relative bg-[#A9272E] ">
