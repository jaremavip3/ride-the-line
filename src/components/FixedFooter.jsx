...
export default function FixedFooter() {
  ...
  const screenings = [
    ...
    },
    {
      ...
      infoLink: "https://filmfreeway.com/Molodist",
      status: false,
    },
  ];
  const mediaSvgs = [
    {
      name: "facebook",
      url: "https://www.facebook.com/share/16P3eoKN8k/?mibextid=wwXIfr",
      svg: (
        <svg width="28" height="28" viewBox="0 0 71 72" fill="none">
          <path
    ...
    {
      name: "instagram",
      url: "https://www.instagram.com/volo4iy?igsh=ZG1hc2xsbWZpZWUy",
      svg: (
        <svg width="28" height="28" viewBox="0 0 71 72" fill="none">
          <path
