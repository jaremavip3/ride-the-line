...
export default function Author() {
  return (
    <>
      ...
      <section className="px-6 py-16 lg:py-24 bg-white text-pretty relative overflow-hidden">
        {/* Grain Overlay */}
        <div
        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-8  mb-12">
            ...
            <div>
              ...
              <p className="text-pretty text-lg leading-relaxed tracking-wide text-gray-600 font-medium">
                Ihor Volochii is a 34-year-old passionate cyclist and adventure filmmaker from Ukraine. With the
                beginning of the full-scale invasion Ihor has dedicated himself to volunteer efforts, channeling his
                skills and energy to support those in need.
              </p>
            </div>
          </div>
          ...
          <div className="relative">
            ...
            <p className="text-pretty text-lg leading-relaxed tracking-wide text-gray-600 md:text-left font-medium">
              ...
              best in the world at different angles. But nowadays reality is that I pass through the dilapidated towns
              and villages of my country and listen to stories that bring goosebumps and tears to my eyes.
            </p>
